...
public class ChangePasswordPage extends GerneralPage {
    ...
    public WebElement getbtnChangePassword() {
        return Constant.WEBDRIVER.findElement(btbChangePassword);
    }

    ;

    public WebElement getlblErrorConfirmMessage() {
        return Constant.WEBDRIVER.findElement(lblErrorConfirmMessage);

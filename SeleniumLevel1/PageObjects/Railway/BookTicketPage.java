...
public class BookTicketPage extends GerneralPage {
    ...
    public String getBookSuccessMessage() {
        return this.getDdlBookSucessMessage().getText();
    }
    ...
    public String getTicketAmountInfor() {
        return this.getDglTicketAmountBookedTicket().getText();
    }
    ...
    public void selectArriveStation(int t) {

        this.getDropDownArriveAt().selectByIndex(t);
    }
    ...
    public void selectTicketAmount(String amount) {
        this.getDropDownTicketAmount().selectByValue(amount);
        this.getDdlDepartFrom().submit();
    }
